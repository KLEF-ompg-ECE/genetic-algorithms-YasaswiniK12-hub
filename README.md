...
|--------------|-----------------|-------------|--------|----------------|
| 0.01         |      75         | 14.9/15.0 KG|  Yes   |     Slow       |
| 0.05         |     77          | 14.4/15.0 KG|  Yes   |     Fast       |
| 0.30         |      78         | 14.1/15.0 KG|  Yes   |     Gradual    |
...
|------------|-------------|-------------|------------------------------|
| 1 — Baseline | mutation_rate = 0.05 |77 |GA quickly improves in early generation and then stabilizes at the best solution |
